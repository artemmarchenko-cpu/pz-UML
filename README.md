...
## Предметна область: Система бронювання квитків у кінотеатрі

Система дозволяє користувачам переглядати розклад сеансів, обирати місця та купувати квитки онлайн. Адміністратор керує фільмами та сеансами.
...
### 1. Use Case Diagram
📄 [diagrams/use-case.md](diagrams/use-case.md)

Показує взаємодію трьох акторів із системою:
- **Гість** — перегляд розкладу, реєстрація
- **Зареєстрований користувач** — бронювання, оплата, скасування
- **Адміністратор** — управління фільмами та сеансами
...
Показує покроковий процес бронювання квитка між користувачем, інтерфейсом, сервісом бронювання, сервісом оплати та базою даних. Включає два сценарії: успішна та відхилена оплата.

---

### 3. Activity Diagram
📄 [diagrams/activity.md](diagrams/activity.md)

Відображає повний процес купівлі квитка — від відкриття сайту до отримання квитка на email. Включає вузли рішень: перевірка авторизації, доступність місць, результат оплати.
